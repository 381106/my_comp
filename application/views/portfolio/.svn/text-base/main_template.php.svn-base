            ...
            <div class="main-page">
                        ...
                        <div class="header">
                            <div class="header-inner clear-block">
                                <div class="float net">
                                    ...
                                    <div> <a class="net_5" href=""></a></div>
                                </div>
                                <div class="logo">
                                    <a href=""><img alt="net_1" src="<?php echo base_url();?>img/logo.png"/></a>
                                </div>
                                <div class="header-2">
                                    <div id="menu">
                                        <ul>
                                            <li><a href="#" class="home-menu" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                            <li><a href="#" class="about-menu-active" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                            <li><a href="#" class="portfolio-menu" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                            <li><a href="#" class="demos-menu" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                            <li><a href="#" class="feedbacks-menu" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                            <li><a href="#" class="contact-menu" title=""></a></li>
                                            <li><img alt="img" src="<?php echo base_url();?>img/separate-menu.png"/></li>
                                        </ul>
                                    </div>
                                    <div class="slogan">
                                    ...
                                    <div class="number">
                                        <b>Tel:</b> 8 908 802 09 66 (3812) 55-77-20
                                    </div>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="footer">
                    <div class="footer-indent">
                        ...
                        <a href="" >contact</a><br/>
                        <div>
                            sbushinskii.com 2011 all right reserved 
                        </div>
                    </div>
                </div><!-- /.footer -->
            </div>
